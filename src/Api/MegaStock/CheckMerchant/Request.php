...
namespace grandmasterx\WebMoney\Api\MegaStock\CheckMerchant;
...
class Request extends MegastockRequest
{
    ...
    {
        return [RequestValidator::TYPE_REQUIRED => ['integratorId', 'integratorWmid', 'resourceId']];
    }
    ...
    {
        $signString = implode('', [$this->loginType, $this->integratorId, $this->integratorWmid, $this->resourceId]);
